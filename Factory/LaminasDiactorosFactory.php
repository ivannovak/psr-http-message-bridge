...
use Laminas\Diactoros\ServerRequestFactory as DiactorosRequestFactory;
 ...
 */
class LaminasDiactorosFactory implements HttpMessageFactoryInterface
{
    public function __construct()
    {
        if (!class_exists('Laminas\Diactoros\ServerRequestFactory')) {
            throw new \RuntimeException('Laminas Diactoros must be installed to use the DiactorosFactory.');
        }
    }
    /**
     * {@inheritdoc}
    ...
    {
        $server = method_exists('Laminas\Diactoros\ServerRequestFactory', 'normalizeServer')
        ...
        $files = method_exists('Laminas\Diactoros\ServerRequestFactory', 'normalizeFiles')
